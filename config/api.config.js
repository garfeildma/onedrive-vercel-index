...
module.exports = {
  ...
  clientId: process.env.NEXT_CLIENT_ID || 'e30a57f5-9831-4b58-9fdf-df40ce13aa86',
  obfuscatedClientSecret: process.env.NEXT_CLIENT_SECRET || 'U2FsdGVkX1+Ece1WOmVjcm+0EbGpsuIqITEbjbu0hyXlt4tM++NcrLCtOuLLIdAH5oDB1zCCfXdAGV+TiVJx+A==',
